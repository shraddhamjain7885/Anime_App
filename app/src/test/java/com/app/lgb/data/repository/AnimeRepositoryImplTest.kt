...
import com.app.lgb.data.remote.AnimeDto
import com.app.lgb.data.remote.AnimeResponseDto
import com.app.lgb.data.remote.ImagesDto
import com.app.lgb.data.remote.JpgDto
...
class AnimeRepositoryImplTest {
    ...
    fun `getAnimeList emits loading and error when api call throws exception`() = runTest {
        // Arrange
        coEvery { apiService.getAnimeList() } throws RuntimeException("API failure")
        ...
        assertEquals("API failure", errorMessage)
    }
}
